...
```mermaid
flowchart LR
    NAV["Dynamics NAV<br/>C/AL · Legacy"]
    BC["D365 Business Central<br/>+ PrintVis"]
    PP["Power Platform<br/>Dataverse · Automate · Pages"]
    AGT["AI Agent Stack<br/>BC Native · Copilot Studio · MCP"]
    OUT(["Intelligent,<br/>Automated Operations"])
    ...
    classDef legacy fill:#64748B,stroke:#475569,color:#ffffff
    classDef core fill:#0078D4,stroke:#005A9E,color:#ffffff
    classDef power fill:#742774,stroke:#5A1F5A,color:#ffffff
    classDef ai fill:#CC785C,stroke:#A85C43,color:#ffffff
    classDef out fill:#1E3A5F,stroke:#0078D4,color:#ffffff
